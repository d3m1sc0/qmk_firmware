 ...
 *                                `------'    `------'
 */
[_QWERTY] = LAYOUT_demisco(
  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,   
  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,         KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOT,
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
  _______, _______, NAVHOM,  NUMEND,  CTL_BK,       SFT_SP,  SYMPGU,  NAVPGD,  _______, _______                  
),
...
[_NUM] = LAYOUT_demisco( 
  ...
  _______, _______, NUM_LK,  _______, _______,      KC_ENT,  FUN_0,   KC_DOT,  _______, _______                  
),
...
[_SYM] = LAYOUT_demisco( 
  ...
  _______, _______, NUM_LK,  FUN,     KC_DEL,       _______, _______, SYM_LK,  _______, _______
),
...
[_NAV] = LAYOUT_demisco( 
  ...
  _______, _______, SYS,     NUM_LK,  NAV_LK,       SYS_LK,  SYM_LK,  SYS,     _______, _______
),
...
[_SYS] = LAYOUT_demisco( 
  ...
  _______, _______, _______, NUM_LK,  NAV_LK,        SYS_LK,  SYM_LK,  _______, _______, _______                  
),
...
[_FUN] =  LAYOUT_demisco( 
  ...
  _______, _______, TSKMGR,  _______, _______,       _______, _______, CALTDEL, _______, _______
)
};
